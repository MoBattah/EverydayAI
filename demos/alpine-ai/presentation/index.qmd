...
![Wispr Flow - Work at the speed you think in every application](images/wisprflow.png){width=85% style="border: 2px solid #e0e0e0; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"}
...
**Open Source Repository:** https://github.com/MoBattah/prompts
- This Presentation
